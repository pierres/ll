...
--
-- Host: localhost
-- Erstellungszeit: 14. August 2006 um 19:54
...
CREATE TABLE avatars (
  ...
  content mediumblob NOT NULL,
  PRIMARY KEY  (id)
) TYPE=MyISAM AUTO_INCREMENT=2194;
...
CREATE TABLE forums (
  ...
  PRIMARY KEY  (id),
  KEY boardid (boardid)
) TYPE=MyISAM AUTO_INCREMENT=332;
...
CREATE TABLE poll_values (
  ...
  PRIMARY KEY  (id),
  KEY pollid (pollid)
) TYPE=MyISAM AUTO_INCREMENT=1069;
...
) TYPE=MyISAM AUTO_INCREMENT=92156;
...
) TYPE=MEMORY MAX_ROWS=300 AVG_ROW_LENGTH=300;
...
) TYPE=MyISAM AUTO_INCREMENT=5117;
...
) TYPE=MyISAM AUTO_INCREMENT=2195;
