...
<Image height="16" width="16" type="image/x-icon">http://'.$this->Board->getHost().'/favicon.ico</Image>
<Url type="text/html" method="get" template="http://'.$this->Board->getHost().'/?page=Search;submit=;search={searchTerms}"/>
