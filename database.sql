...
-- 
-- Host: localhost
-- Erstellungszeit: 08. Juli 2005 um 19:05
...
CREATE TABLE `forums` (
  ...
  `allownew` tinyint(1) unsigned default NULL,
  `allowreply` tinyint(1) unsigned default NULL,
  `threads` mediumint(8) unsigned NOT NULL default '0',
  `posts` mediumint(8) unsigned NOT NULL default '0',
  `mods` mediumint(8) unsigned NOT NULL default '0',
  PRIMARY KEY  (`id`),
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=37566 ;
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY  (`id`),
  KEY `name` (`name`(10))
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1509 ;
